...
\def\@endpart{\par\nobreak\vfil\newpage}
\makeatother
\includeonly{chapters/2501,chapters/2502,appendix/appendix-periodic,appendix/appendix-data,appendix/appendix-concepts,appendix/appendix-formulas}

\begin{document}
    \maketitle
    \frontmatter                 % 序＋目录用罗马数字页码，正文起于阿拉伯数字 1

    % 序在 \includeonly 白名单之外，故用 \input：
    ...
    \cleardoublepage
    % 元级标题为双语：中英分行，两行皆原字号（\small 已撤）。
    % 实测：英文串宽 190.0pt，正文列宽 392.6pt，富余 202pt，不需缩号。
    % \texorpdfstring 把排版命令（\\）与双语全文挡在 PDF 书签之外，
    % 书签只取中文短语，免得书签面板里塞满两行。
    \part{\texorpdfstring{二〇二五学年第一学期 \\First Semester, Academic Year 2025}{二〇二五学年第一学期 First Semester, Academic Year 2025}}
    ...
    \cleardoublepage
    \part{\texorpdfstring{二〇二五学年第二学期 \\Second Semester, Academic Year 2025}{二〇二五学年第二学期 Second Semester, Academic Year 2025}}
    ...
    \include{appendix/appendix-periodic}

    \include{appendix/appendix-data}

    \include{appendix/appendix-concepts}

    \include{appendix/appendix-formulas}
