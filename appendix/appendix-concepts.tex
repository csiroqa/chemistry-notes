\chapter{知识清单}\label{appendix:知识清单}
    ...
    \section{溶液中的三大平衡}\label{app:知识点-三大平衡}
        ...
        \subsection{弱电解质的电离平衡}
            ...
            \begin{itemize}
                ...
                \item 电离常数 \(K_\text{i}\) 只受温度影响，\textcolor{red}{温度升高 \(K_\text{i}\) 增大}。
        ...
        \subsection{盐类水解}
            ...
            \begin{itemize}
                ...
                \item \textcolor{red}{双水解（完全水解）}：正离子 \cemh{Al^{3+}}、\cemh{Fe^{3+}}；负离子 \cemh{S^{2-}}（\cemh{HS-}）、\cemh{CO3^{2-}}（\cemh{HCO3-}）、\cemh{SO3^{2-}}、\cemh{SiO3^{2-}}、\cemh{ClO-}。如 \cemh{Al^{3+} + 3HCO3- \xleq{} Al(OH)3 v + 3CO2 ^}（泡沫灭火器）。
            \end{itemize}
    ...
    \section{物质结构与性质}\label{app:知识点-结构性质}
        ...
        \subsection{VSEPR 理论与杂化轨道}
            ...
            \begin{itemize}
                \item 价层电子对数 \(=\) 成键 \(\upsigma\) 电子对数 \(+\) 孤电子对数：
                \[
                    \text{价层电子对数} = n + \frac{\text{A 的价电子数} - \text{离子电荷} - n \times \text{B 的单电子数}}{2}
                \]
        ...
        \subsection{晶体}
            ...
            \begin{minipage}[t]{0.47\textwidth}
                ...
                \begin{datas}[leftmargin=*]
                    \item 离子晶体：正、负离子通过离子键结合；无方向性、饱和性；熔点影响——电荷 \(>\) 半径；熔沸点高、硬度较大、熔融或溶于水导电。
                    \item 共价晶体：原子间共价键（有方向性，无密堆积）；熔点影响——键能；如金刚石、\cemh{Si}、\cemh{SiO2}、\cemh{SiC}、\cemh{BN}。
                \end{datas}
            \end{minipage}
            \hfill
            \begin{minipage}[t]{0.47\textwidth}
                \begin{datas}[leftmargin=*]
                    \item 分子晶体：分子间作用力；熔沸点低、硬度小；熔点影响——有无氢键、相对分子质量、分子极性。
                    \item 金属晶体：金属键（自由电子气）；有金属光泽、延展性、导电导热。
                \end{datas}
            \end{minipage}
            \par\vspace{0.6em}
    ...
    \section{化学反应与电能}\label{app:知识点-电化学}
        ...
        \subsection{氧化还原反应}
            ...
            \begin{itemize}
                ...
                \item 氧化性、还原性受\textcolor{red}{浓度、pH、温度}影响；\cemh{H+} 参与的反应，\cemh{c(H+)}\(\uparrow\) 氧化性\(\uparrow\)。
            \end{itemize}
