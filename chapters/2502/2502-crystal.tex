\chapter{晶体结构与性质} \label{chap:晶体结构与性质}
    ...
    \section{各类晶体}\label{sect:各类晶体}
        ...
        \subsection{离子晶体}\label{subsec:离子晶体}
            ...
            % TODO: 来源未知 ——“有些离子晶体中还存在共价键（如 SO₄²⁻、NO₃⁻ 等多原子离子），有些还存在氢键、范德华力或配位键等作用力。”（待与课本/笔记源稿核对）
        ...
        \subsection{共价晶体}\label{subsec:共价晶体}
            ...
            % TODO: 来源未知 ——“由于共价键有方向性，共价晶体中没有密堆积的特征（与离子晶体和金属晶体不同）。”（待与课本/笔记源稿核对）
        ...
        \subsection{金属晶体}\label{subsec:金属晶体}
            ...
            % TODO: 来源未知 ——“金属正离子间依靠自由电子而产生的强烈相互作用，叫做金属键。”（待与课本/笔记源稿核对）
        ...
        \subsection{过渡型晶体}\label{subsec:过渡型晶体}
            ...
            % TODO: 来源未知 ——“TiCl4/TiO2 过渡型晶体归属及熔点数据。”（待与课本/笔记源稿核对）
    ...
    \section{晶胞}\label{sect:晶胞}
        ...
        % 四种位置的绘图说明（仿手稿示意图，每格一个 minipage，待补图）
        \cellfigph{顶角（顶点）原子 1/8}{绘制顶角原子被 8 个晶胞共用的示意图}
        \cellfigph{棱上原子 1/4}{绘制棱上原子被 4 个晶胞共用的示意图}
        \cellfigph{面上（面心）原子 1/2}{绘制面心原子被 2 个晶胞共用的示意图}
        \cellfigph{内部（体心）原子 1}{绘制体心原子完全属于该晶胞的示意图}
        ...
        \subsection{典型金属晶体晶胞}\label{subsec:典型金属晶体晶胞}
            ...
            \subsubsection{简单立方堆积（非密堆积）}
                ...
                \cellfigph{简单立方堆积晶胞示意图（待补）}{绘制简单立方堆积晶胞示意图，可参考课本图}
            ...
            \subsubsection{体心立方堆积（密堆积）}
                ...
                \cellfigph{体心立方堆积晶胞示意图（待补）}{绘制体心立方堆积晶胞示意图，可参考课本图}
            ...
            \subsubsection{面心立方堆积（最密堆积）}
                ...
                \cellfigph{面心立方堆积晶胞示意图（待补）}{绘制面心立方堆积晶胞示意图，可参考课本图}
            ...
            \subsubsection{六方堆积（最密堆积）}
                ...
                \cellfigph{六方堆积晶胞示意图（待补）}{绘制六方堆积晶胞示意图，可参考课本图}
        ...
        \subsection{常见离子晶体晶胞}\label{subsec:常见离子晶体晶胞}
            ...
            \subsubsection{\texorpdfstring{\cemh{NaCl}}{NaCl} 晶体}
                ...
                \cellfigph{NaCl 晶胞示意图（待补）}{绘制 NaCl 晶胞示意图，可参考课本图}
            ...
            \subsubsection{\texorpdfstring{\cemh{CsCl}}{CsCl} 晶体}
                ...
                \cellfigph{CsCl 晶胞示意图（待补）}{绘制 CsCl 晶胞示意图，可参考课本图}
            ...
            \subsubsection{\texorpdfstring{\cemh{CaF2}}{CaF2} 晶体}
                ...
                \cellfigph{CaF2 晶胞示意图（待补）}{绘制 CaF₂ 晶胞示意图，可参考课本图}
            ...
            \subsubsection{\texorpdfstring{\cemh{ZnS}}{ZnS} 晶体}
                ...
                \cellfigph{ZnS 晶胞示意图（待补）}{绘制 ZnS 晶胞示意图，可参考课本图}
        ...
        \subsection{常见共价晶体晶胞}\label{subsec:常见共价晶体晶胞}
            ...
            \subsubsection{金刚石晶胞}
                ...
                % TODO: 绘制金刚石晶胞示意图（右侧占位，与 ZnS 相同布局）
                \noindent
                ...
                \begin{minipage}[t]{0.35\textwidth}
                    \centering
                    \fbox{\parbox[c][5em][c]{0.9\linewidth}{\centering\footnotesize\textcolor{gray}{金刚石晶胞示意图（待补）}}}
                \end{minipage}
        ...
        \subsection{分子晶体晶胞}\label{subsec:分子晶体晶胞}
            ...
            \subsubsection{冰晶体（非密堆积）}
                ...
                % TODO: 来源未知 ——“由于氢键的方向性，使冰晶体中每个水分子与正四面体顶角的 4 个相邻水分子相互吸引，形成空隙较大的网状体……”与“1 mol H₂O 形成的冰晶体中含氢键 2 mol。”（待与课本/笔记源稿核对）
