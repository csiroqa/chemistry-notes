\chapter{晶体结构与性质} \label{chap:晶体结构与性质}
    ...
    \section{各类晶体}\label{sect:各类晶体}
        ...
        \subsection{离子晶体}\label{subsec:离子晶体}
            ...
            基本微粒：\textcolor{red}{正、负离子}\qquad 离子键

            \(\Rightarrow\) 既无方向性，也无饱和性

            \(\Rightarrow\) 离子化合物

            \textbf{\textcolor{red}{影响离子晶体熔点的因素：}}
            ...
            硝酸乙基铵（\cemh{CH3CH2NH3NO3}）熔点：\SI{12}{\degreeCelsius}
        ...
        \subsection{分子晶体}\label{subsec:分子晶体}
            ...
            \begin{enumerate}
                \item 熔沸点低，有很多常温下是气体或液体，液体多易挥发，固体有些易升华（干冰、碘、萘）。
                \item 硬度小
                \item 不导电，固态、熔融状态均不导电，少数溶于水导电（酸）
                \item 溶解性，一般符合相似相溶。
            \end{enumerate}

            \textbf{\textcolor{red}{影响分子晶体熔沸点的因素：}}（分子间作用力大小）
        ...
        \subsection{金属晶体}\label{subsec:金属晶体}
            ...
            ——金属正离子与自由电子通过金属键结合而成的晶体。

            基本微粒：\textcolor{red}{金属正离子、自由电子}\qquad 金属键

            金属键——本质静电作用，无方向性、饱和性（与离子晶体类似）。
            ...
            \textbf{\textcolor{red}{影响金属晶体熔沸点的因素：}}（金属键强弱）
        ...
        \subsection{混合型晶体——石墨}\label{subsec:混合型晶体石墨}
            ...
            每个碳原子通过 \cemh{sp^2} 与另外 3 个碳原子相连 \(\Rightarrow\) 平面网状结构。

            每个碳原子还有一个垂直于平面的未杂化的 2p 轨道，有一个电子 \(\Rightarrow\) 形成覆盖整个平面的离域\(\uppi\) 键。
    ...
    \section{晶胞}\label{sect:晶胞}
        ...
        % 四种位置（仿手稿线框示意图，每格一个 minipage）
        \noindent
        \begin{minipage}[t]{0.48\textwidth}
            \centering
            \input{figures/crystal/share-corner.tikz}\\[2pt]
            \footnotesize\textcolor{gray}{顶角：被 8 个晶胞共用（\(1/8\)）}
        \end{minipage}\hfill
        \begin{minipage}[t]{0.48\textwidth}
            \centering
            \input{figures/crystal/share-edge.tikz}\\[2pt]
            \footnotesize\textcolor{gray}{棱上：被 4 个晶胞共用（\(1/4\)）}
        \end{minipage}\\[6pt]
        \noindent
        \begin{minipage}[t]{0.48\textwidth}
            \centering
            \input{figures/crystal/share-face.tikz}\\[2pt]
            \footnotesize\textcolor{gray}{面上（面心）：被 2 个晶胞共用（\(1/2\)）}
        \end{minipage}\hfill
        \begin{minipage}[t]{0.48\textwidth}
            \centering
            \input{figures/crystal/share-body.tikz}\\[2pt]
            \footnotesize\textcolor{gray}{内部（体心）：完全属于该晶胞（\(1\)）}
        \end{minipage}
        ...
        \subsection{典型金属晶体晶胞}\label{subsec:典型金属晶体晶胞}
            ...
            \subsubsection{简单立方堆积（非密堆积）}
                ...
                \cellfig{cell-simple-cubic}{简单立方堆积晶胞（代表金属：\cemh{Po}）}
            ...
            \subsubsection{体心立方堆积（密堆积）}
                ...
                \cellfig{cell-bcc}{体心立方堆积晶胞（代表金属：\cemh{Na}、\cemh{K}、\cemh{Fe} 等）}
            ...
            \subsubsection{面心立方堆积（最密堆积）}
                ...
                \cellfig{cell-fcc}{面心立方堆积晶胞（代表金属：\cemh{Cu}、\cemh{Ag}、\cemh{Au} 等）}
            ...
            \subsubsection{六方堆积（最密堆积）}
                ...
                \cellfig{cell-hcp}{六方最密堆积晶胞（ABAB…，代表金属：\cemh{Mg}、\cemh{Zn}、\cemh{Ti}）}
        ...
        \subsection{常见离子晶体晶胞}\label{subsec:常见离子晶体晶胞}
            ...
            \subsubsection{\texorpdfstring{\cemh{NaCl}}{NaCl} 晶体}
                ...
                \cellfig{cell-na-cl}{\textcolor{green!50!black}{\cemh{Cl-}}（绿）与 \textcolor{violet!60!black}{\cemh{Na+}}（紫）}
                ...
                \textcolor{blue}{离子化合物的化学式只表示最简个数比，不是分子式。}
            ...
            \subsubsection{\texorpdfstring{\cemh{CsCl}}{CsCl} 晶体}
                ...
                \cellfig{cell-cs-cl}{\textcolor{pink!70!red}{\cemh{Cs+}}（粉）与 \textcolor{green!50!black}{\cemh{Cl-}}（绿）}
            ...
            \subsubsection{\texorpdfstring{\cemh{CaF2}}{CaF2} 晶体}
                ...
                \cellfig{cell-ca-f2}{\textcolor{green!50!black}{\cemh{Ca^{2+}}}（绿）与 \textcolor{blue!60!black}{\cemh{F-}}（蓝）}
            ...
            \subsubsection{\texorpdfstring{\cemh{ZnS}}{ZnS} 晶体}
                ...
                \cellfig{cell-zns}{\textcolor{yellow!60!orange}{\cemh{S^{2-}}}（黄）与 \textcolor{gray!40!black}{\cemh{Zn^{2+}}}（灰黑），\cemh{Zn^{2+}} 位于 \cemh{S^{2-}} 四面体空隙}
        ...
        \subsection{晶体密度计算}\label{subsec:晶体密度计算}
            ...
            \subsubsection{已知晶胞边长}
                ...
                \begin{xmp}{已知晶胞边长计算 \cemh{CsCl} 的密度}
        ...
        \subsection{常见共价晶体晶胞}\label{subsec:常见共价晶体晶胞}
            ...
            \subsubsection{金刚石晶胞}
                ...
                \begin{minipage}[t]{0.35\textwidth}
                    \centering
                    \input{figures/crystal/cell-diamond.tikz}
                \end{minipage}
            ...
            \subsubsection{金刚石模型演变}
                ...
                \[
                    \left\{
                    \begin{array}{ll}
                        金刚石结构 & \text{熔沸点高、硬度大（共价晶体）}\\
                        石墨结构 & \text{层状结构（混合型晶体，六方氮化硼/白石墨）}
                    \end{array}
                    \right.
                \]
                ...
                \noindent\begin{minipage}[t]{0.35\textwidth}
                    \centering
                    \chemfig{B-[0]N-[7]B-[5]N-[4]B-[3]N-[4]B-[5]N-[7]B(-[5]N)-[0]N(-[7]B)-[1]}

                    \footnotesize\textcolor{gray}{六方氮化硼（白石墨）结构示意}
                \end{minipage}

                % TODO: 补充六方氮化硼（白石墨）结构说明、BN 两种结构的对比分析
        ...
        \subsection{分子晶体晶胞}\label{subsec:分子晶体晶胞}
            ...
            \subsubsection{大多数分子晶体的晶胞特点}
                ...
                干冰：\quad \(a=\SI{0.57}{\nm}\)\quad \(\rho=\SI{1.578}{\g\per\cubic\cm}\)

                \cellfig{cell-dry-ice}{干冰晶胞：\cemh{CO2} 分子位于面心立方格点上（长轴取向不同），分子密堆积}

            \subsubsection{冰晶体（非密堆积）}

                每个水分子依靠氢键与周围位于正四面体顶角的四个水分子结合形成冰晶体。

                \cellfig{cell-ice}{冰：水分子通过氢键形成四面体网络（示意），\textcolor{red}{氢键有方向性、饱和性}，空隙大 \(\Rightarrow\) 冰密度小于水}
        ...
        \subsection{晶体 X 射线衍射分析}\label{subsec:晶体X射线衍射分析}
            ...
            一定波长 \(\Rightarrow\) 晶体会显示特有的衍射图像

            可测定：

            \begin{itemize}
                \item 晶胞的大小和形状
                \item 晶胞中原子种类、数目及位置排列
