\chapter{晶体结构与性质} \label{chap:晶体结构与性质}
    ...
    \section{晶胞}\label{sect:晶胞}
        ...
        \cellfig{share-corner}{顶角（顶点）原子：被 8 个晶胞共用（\(1/8\)）}
        \cellfig{share-edge}{棱上原子：被 4 个晶胞共用（\(1/4\)）}
        \cellfig{share-face}{面上（面心）原子：被 2 个晶胞共用（\(1/2\)）}
        \cellfig{share-body}{内部（体心）原子：完全属于该晶胞（\(1\)）}
        ...
        \subsection{常见离子晶体晶胞}\label{subsec:常见离子晶体晶胞}
            ...
            \subsubsection{\texorpdfstring{\cemh{NaCl}}{NaCl} 晶体}
                ...
                \cellfig{cell-na-cl}{\textcolor{green!55!black}{\cemh{Cl-}}（绿）与 \textcolor{violet!65!black}{\cemh{Na+}}（紫）}
            ...
            \subsubsection{\texorpdfstring{\cemh{CsCl}}{CsCl} 晶体}
                ...
                \cellfig{cell-cs-cl}{\textcolor{blue!60!black}{\cemh{Cs+}}（蓝）与 \textcolor{green!55!black}{\cemh{Cl-}}（绿）}
            ...
            \subsubsection{\texorpdfstring{\cemh{CaF2}}{CaF2} 晶体}
                ...
                \cellfig{cell-ca-f2}{\textcolor{green!60!black}{\cemh{Ca^{2+}}}（绿）与 \textcolor{blue!70!black}{\cemh{F-}}（蓝）}
            ...
            \subsubsection{\texorpdfstring{\cemh{ZnS}}{ZnS} 晶体}
                ...
                \cellfig{cell-zns}{\textcolor{orange!80!black}{\cemh{S^{2-}}}（黄）与 \textcolor{gray}{\cemh{Zn^{2+}}}（灰），\cemh{Zn^{2+}} 位于 \cemh{S^{2-}} 四面体空隙}
        ...
        \subsection{常见共价晶体晶胞}\label{subsec:常见共价晶体晶胞}
            ...
            \subsubsection{金刚石晶胞}
                ...
                \begin{minipage}[t]{0.35\textwidth}
                    \centering
                    \includegraphics[width=0.95\linewidth]{figures/crystal/cell-diamond.pdf}
                \end{minipage}
