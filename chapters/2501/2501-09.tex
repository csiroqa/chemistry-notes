\section{\S 2.2 分子结构与物质性质}\label{sect:分子结构与物质性质}
	...
	\subsection{分子极性}\label{subsec:分子极性}
		...
		\begin{dfn}{极性分子与非极性分子}
			极性分子：在电场中具有取向作用的分子、正电荷中心与负电荷中心\textcolor{red}{不重合}的分子。

			非极性分子：在电场中无取向作用的分子、正电荷中心与负电荷中心\textcolor{blue}{重合}的分子。
		\end{dfn}
		...
		\begin{tabular}{|c|c|c|c|}
			...
			单原子分子 & -- & 稀有气体 & 非极性 \\
			\hline
			\shortstack{双原子分子\\ \cemh{A2}\\ \cemh{AB}} & 直线形 & \shortstack{\cemh{H2}、\cemh{O2}、\cemh{N2}、\cemh{Cl2} 等\\ \cemh{HX}、\cemh{CO} 等} & \shortstack{非极性\\ 极性} \\
			\hline
			\shortstack{三原子分子\\ \cemh{ABA}\\ \cemh{ABA}\\ \cemh{ABC}} & \shortstack{直线形\\ 角形（V 形、折线形）\\ 角形或直线形} & \shortstack{\cemh{BeCl2}、\cemh{CO2}、\cemh{CS2} 等\\ \cemh{H2O}、\cemh{H2S}、\cemh{SO2} 等\\ \cemh{HCN}、\cemh{HClO}} & \shortstack{非极性\\ 极性\\ 极性} \\
			\hline
			\shortstack{四原子分子\\ \cemh{AB3}\\ \cemh{AB3}} & \shortstack{平面正三角形\\ 三角锥形} & \shortstack{\cemh{BF3}、\cemh{BCl3}、\cemh{SO3} 等\\ \cemh{NH3}、\cemh{PH3}、\cemh{PCl3}、\cemh{NF3} 等} & \shortstack{非极性\\ 极性} \\
			\hline
			\shortstack{五原子分子\\ \cemh{AB4}\\ \cemh{AB_xC_y}(x+y=4)} & \shortstack{正四面体形\\ 四面体形} & \shortstack{\cemh{CH4}、\cemh{CCl4} 等\\ \cemh{CH3Cl}、\cemh{CH2Cl2}、\cemh{CHCl3}} & \shortstack{非极性\\ 极性} \\
			\hline
		\end{tabular}
		\end{center}
	...
	\subsection{相似相溶原理}\label{subsec:相似相溶原理}
		...
		\begin{pbm}{物质普遍存在三态变化，由分子构成的物质三态变化时也伴随能量变化，这说明什么？}
		\end{pbm}
	...
	\subsection{氢键}\label{subsec:氢键}
		...
		\begin{dfn}{氢键}
			一个分子中电负性很强的原子与另一个分子中的氢原子之间形成的较强相互作用。
		\end{dfn}
