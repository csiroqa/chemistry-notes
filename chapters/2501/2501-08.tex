    ...
    \subsection{价层电子对互斥理论（VSEPR）}\label{subsec:VSEPR}
        ...
        \subsubsection{价层电子对的排列方式}\label{subsubsec:价层电子对排列方式}
            ...
            \begin{tabular}{|c|c|c|c|c|c|c|}
                \hline
                \noindent\textbf{价层电子对数} & \textbf{2 对} & \textbf{3 对} & \textbf{4 对} & \textbf{5 对} & \textbf{6 对} \\
                \hline
        ...
        \subsubsection{实例分析}\label{subsubsec:VSEPR实例分析}
            ...
            \begin{tabular}{|c|c|c|c|c|c|}
                ...
                \cline{3-6}
                & 三角形 & 2 & 1 & \cemh{SO2} & \makecell{角形 \\\footnotesize（折线形、V 字形）} \\
                \hline
                \multirow{3}{*}{4} & 正四面体形 & 4 & 0 & \makecell{\cemh{CCl4}, \cemh{CH4},\\\cemh{NH4+}} & 正四面体形 \\
                \cline{3-6}
                & 四面体形 & 3 & 1 & \makecell{\cemh{NH3}, \cemh{PCl3},\\\cemh{PH3}} & 三角锥形 \\
                \cline{3-6}
                & 四面体形 & 2 & 2 & \makecell{\cemh{H2O}, \cemh{H2S}} & \makecell{角形 \\\footnotesize（折线形、V 字形）} \\
                \hline
            \end{tabular}
            \end{center}
