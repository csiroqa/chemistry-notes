\section{\S 3.1 水的电离和溶液酸碱性}\label{sect:水的电离和溶液酸碱性}
    ...
    \subsection{有关 pH 的计算}\label{subsec:有关pH的计算}
        ...
        \subsubsection{\texorpdfstring{\cemh{[OH^-]}}{OH⁻}与 pH 之间的换算}\label{subsubsec:[OH^-]与pH之间的换算}
            \begin{xmp}
                ...
                \begin{enumerate}
                    ...
                    \item 配置\(\cemh{pH} = 14\)的 \cemh{NaOH} 溶液\SI{100}{\ml}，需 \cemh{NaOH}\uline{\makebox[1.5em]{4}}\SI{}{\gram}；
        ...
        \subsubsection{稀释计算}\label{subsubsec:稀释计算}
            ...
            \begin{rmk}
                强酸强碱每稀释 \( 10 \) 倍，\cemh{[H+]}、\cemh{[OH^-]} 变化 \( 10 \) 倍，pH 改变 \( 1 \)；但酸不会稀释成碱，碱不会稀释成酸，pH 最终逼近 \( 7 \)。
            \end{rmk}
        ...
        \subsubsection{非常温计算}\label{subsubsec:非常温计算}
            ...
            \begin{rmk}
                先算出该温度下的\(K_\text{W}\)，其他计算同前。
            \end{rmk}
            
    \subsection{水电离出的\texorpdfstring{\cemh{[H+]}}{H⁺}和\texorpdfstring{\cemh{[OH^-]}}{OH⁻}（暂时只有酸和碱）}\label{subsec:水电离出的[H+]和[OH^-]}

        \begin{xmp}{常温下由水电离出的 \cemh{[H+]}（或 \cemh{[OH^-]}）判断溶液 pH}
        ...
        \begin{xmp}{酸、碱溶液中水电离出的 \cemh{[H+]} 与 \cemh{[OH^-]}（标注"水"）}
            1、pH＝3 的盐酸溶液中，水电离出的\(\cemh{[H+]}_\text{水}=\uline{\makebox[9em]{\SI{1E-11}{\mole\per\litre}}}\)，水电离出的\(\cemh{[OH^-]}_\text{水}=\uline{\makebox[9em]{\SI{1E-11}{\mole\per\litre}}}\) 。

            2、pH＝11 的 \cemh{NaOH} 溶液中，水电离出的\(\cemh{[H+]}_\text{水}=\uline{\makebox[9em]{\SI{1E-11}{\mole\per\litre}}}\) ，水电离出的\(\cemh{[OH^-]}_\text{水}=\uline{\makebox[9em]{\SI{1E-11}{\mole\per\litre}}}\) 。
        \end{xmp}

        \begin{rmk}
            酸碱抑制水的电离，使水的电离程度减小；

            若酸、碱电离出的 \cemh{[H+]} 和 \cemh{[OH^-]} 对应相等，则抑制程度相同。

            酸、碱溶液中，水电离的量看溶液的 \cemh{[H+]}、\cemh{[OH^-]} 中小的那个。
        \end{rmk}
