    ...
    \subsection{水解平衡}\label{subsec:水解平衡}
        ...
        \subsubsection{水解常数}\label{subsubsec:水解常数}
            ...
            \subsection{双水解反应}\label{subsec:双水解反应}
                ...
                \begin{dfn}{双水解反应}
                    双水解反应——两种离子水解相互促进，生成沉淀或气体，最终完全水解的反应。
                \end{dfn}

                    \textcolor{red}{不是一个水解显酸性、一个水解显碱性就一定会双水解。}\footnote{\textcolor{red}{新知识体系下的双水解反应指两种离子水解相互促进的反应，并将原本称作双水解反应的反应称作完全的双水解反应}}
