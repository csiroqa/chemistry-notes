...
\addcontentsline{toc}{section}{\S 3.0 基础知识复习}

    \subsection*{电解质与非电解质} \label{subsec:电解质与非电解质}
    \addcontentsline{toc}{subsection}{电解质与非电解质}
    ...
    \addcontentsline{toc}{subsection}{强弱电解质}
        ...
        \begin{table}[htbp]
            ...
            \begin{tabular}{|c|c||c|c|}
                ...
                \hline\footnotesize
                \cemh{HCOOH} &\footnotesize \SI{1.8E-4}{} &\footnotesize 
                ...
                \cemh{HCN} &\footnotesize \SI{4.0E-10}{} &\footnotesize 
                \multirow{2}[0]{*}{\cemh{H2C2O4}} &\footnotesize \( K_\text{a1} = \SI{5.6E-2}{} \) \\\footnotesize 
    ...
    \addcontentsline{toc}{subsection}{电解质与离子、共价化合物的关系}
