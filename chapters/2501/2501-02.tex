        ...
        \subsubsection{影响电离度的因素}\label{subsubsec:影响电离度的因素}
            ...
            \begin{enumerate}
                ...
                \ \phantom{\(T\)}\textcolor{red}{稀释促进电离（越稀越电离）}
                    ...
                    \textcolor{red}{\(\therefore\) 弱酸弱碱溶液每稀释 10 倍，pH 改变小于 1。}
    ...
    \subsection{电离常数}\label{subsec:电离常数}
        ...
        \noindent   2. 计算弱酸、弱碱 pH
            ...
            \begin{xmp}
                ...
                []
                []
                计算\(c=\SI{0.1}{\mole\per\litre}\)醋酸溶液的 pH 和电离度\(\alpha\)
                \begin{center}
        ...
        \noindent   3. 辅助分析离子、分子浓度变化
            ...
            \begin{xmp}{计算 \SI{25}{\degreeCelsius} 时纯水的电离度}
        ...
        \noindent   5. 判断酸碱反应进行的方向
            ...
            \begin{xmp}
                ...
                \quad 〔\cemh{CN- + HSO3^- \xleq{} HCN + SO3^2-}〕
                ...
                \quad 〔\cemh{HCO3^- + SO2 \xleq{} CO2 + HSO3^-}〕
