\section{\S 3.4 沉淀溶解平衡}\label{sect:沉淀溶解平衡}
    ...
    \subsection[溶度积常数]{溶度积常数（简称：溶度积；符号：\(K_{\text{sp}}\)）}\label{subsec:溶度积常数}
        ...
        \subsubsection{溶度积与溶解度的关系}\label{subsubsec:溶度积与溶解度的关系}
            ...
            对于 \cemh{A2B} 型或 \cemh{AB2} 型难溶电解质，\( s = \sqrt[\scriptstyle 3]{\frac{K_\text{sp}}{4}} \)
        ...
        \begin{xmp}
            ...
            \Circled{3} \SI{1.08E-7}{\mole\per\litre}
            
        \end{xmp}

        \begin{dfn}{同离子效应}
            含有相同离子的易溶强电解质时，沉淀溶解平衡逆向移动，难溶电解质的溶解度减小。
        \end{dfn}
        ...
        \subsubsection{难溶氢氧化物的开始沉淀 pH 和完全沉淀 pH}\label{subsubsec:难溶氢氧化物的开始沉淀pH和完全沉淀pH}
            ...
            金属离子的浓度为\SI{0.01}{\mole\per\litre}
            ...
            \( \displaystyle K_\text{sp}(\cemh{Fe(OH)3}) = \cemh{[Fe^{3+}]} \cdot \cemh{[OH^-]}^3 \quad \cemh{[OH^-]} = \sqrt[\scriptstyle 3]{K_{\text{sp}}/\cemh{[Fe^{3+}]}} \quad \cemh{[H^+]} = \frac{K_\text{W}}{\cemh{[OH^-]}} \)
    ...
    \subsection{沉淀溶解平衡的移动}\label{subsec:沉淀溶解平衡的移动}
        ...
        \subsubsection{沉淀的转化}\label{subsubsec:沉淀的转化}
            ...
            \begin{xmp}{计算 \cemh{AgCl} 转化为 \cemh{AgI} 的进行程度}
            ...
            \begin{xmp}{计算 \cemh{AgI} 转化为 \cemh{Ag2S} 的进行程度}
            ...
            \textcolor{blue}{一般来说，同种离子的难溶物，溶解度小的易转化成溶解度更小的；\(K_\text{sp}\)大小相差越大，转化越完全。}

            \begin{xmp}{\cemh{Mg(OH)2} 与 \cemh{FeCl3} 反应能否发生}
        ...
        \subsubsection{沉淀的溶解}\label{subsubsec:沉淀的溶解}
            ...
            \[
                K = \frac{K_\text{sp}(\cemh{Mg(OH)2})}{K_\text{W}^2} = \frac{\num{8.45E-12}}{\left(\num{1.0E-14}\right)^2} = \num{8.45E16}
            .\]
            ...
            \textcolor{red}{计算常温下该反应的\(K\)}
            \[
                K = \frac{K_\text{sp}(\cemh{CaCO3})}{K_\text{a1}(\cemh{H2CO3})\cdot K_\text{a2}(\cemh{H2CO3})} = \frac{\num{4.96E-9}}{\num{4.2E-7}\cdot\num{4.8E-11}} = \num{2.46E8}
            .\]
